...
exports.setSplashScreenMainActivity = setSplashScreenMainActivity;
...
const withAndroidSplashMainActivity = config => {
  return (0, _configPlugins().withMainActivity)(config, config => {
    config.modResults.contents = setSplashScreenMainActivity(config, config.modResults.contents, config.modResults.language);
    return config;
  });
};
...
function setSplashScreenMainActivity(config, mainActivity, language) {
